...
func (p *I18n) Middleware(c *Context) error {
	write := false
...
func (p *I18n) E(c *Context, code string, args ...interface{}) error {
...
func (p *I18n) T(c *Context, code string, args ...interface{}) string {
	lng := c.Get(LOCALE).(string)
	msg, err := p.getMessage(lng, code)
	if err != nil {
		return code
	}
